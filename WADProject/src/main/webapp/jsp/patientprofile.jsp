...
<body
	onLoad="toggleFormInputs(); toggleDescriptionInputs(); togglePasswordInputs()">
	...
	<div class="box">
		...
		<div class="row content">
			...
			<div class="content">
						...
						<table>
							...
							<tr>
								...
								<td><form:input path="name" name="name"
										value="${user.name}"></form:input></td>
							</tr>

							<tr>
								<td>Gender</td>
								<td><form:input path="gender" name="gender"
										value="${user.gender}"></form:input></td>
							</tr>

							<tr>
								<td>Phone</td>
								<td><form:input path="phone" name="phone"
										value="${user.phone}"></form:input></td>
							</tr>

							<tr>
								<td>Address</td>
								<td><form:input path="address" name="address"
										value="${user.address}"></form:input></td>
							</tr>
				...
				<div style="flex-grow: 1; flex-basis: auto;">
					<form name="patientMedicalForm" action="editDescription"
						method="post">
						<table>
							<tr>
								<td>Allergy</td>
								<td><textarea name="allergy">${user.description.allergy}</textarea>
								</td>
							</tr>
							<tr>
								<td>Background disease</td>
								<td><textarea name="background">${user.description.background}</textarea>
								</td>
							</tr>
							<tr>
								<td>Current symptoms/well-being</td>
								<td><textarea name="current">${user.description.current}</textarea>
								</td>
							</tr>
							<tr>
								<td><button type="button"
										onclick="toggleDescriptionInputs()">Edit Medical
				...
				<div>
					<form action="editPassword" method="post">
						<button type="button" onclick="togglePasswordInputs()">Change
							Password</button>
	...
	<div class="row footer">
		<div style="text-align: right; width: 100%;">This is a project
			for the course Web application development</div>
	</div>
