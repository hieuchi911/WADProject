									...
									<div class="row">
										...
										<div class="col-lg-10"><br>
											...
											<table>
												<tr>
													<td>
														<form action="meet-${appointment.doctor}" method="get">
															<button class="left-button">Meet</button>
														</form>
													</td>
													<td>
														<form action="take-${appointment.doctor}" method="get">
															<button class="right-button">Prescription</button>
														</form>
													</td>
												</tr>
											</table>
