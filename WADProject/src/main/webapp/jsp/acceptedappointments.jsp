									...
									<div class="row">
										...
										<div class="col-lg-10"><br>
											...
											<table>
												<tr>
													<td>
														<form action="meet-${appointment.patient}" method="get">
															<button class="left-button">Meet</button>
														</form>
													</td>
													<td>
														<form action="prescribe-${appointment.patient}" method="get">
															<button class="right-button"><span style="margin-left: 10px;">Prescribe</span></button>
														</form>
													</td>
												</tr>
											</table>
