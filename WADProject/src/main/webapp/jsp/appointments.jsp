...
<body>
    ...
    <section class="appointment extrapad">
        <div class="container">
            <div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-8"><br>
											...
											<table>
												<tr>
													<td>
														<form action="${appointment.patient}-acceptRequest" method="get">
															<button class="left-button">Accept</button>
														</form>
													</td>
													<td>
														<form action="${appointment.patient}-rejectRequest" method="get">
															<button class="right-button"><span style="margin-left: 20px;">Reject</span></button>
														</form>
													</td>
												</tr>
											</table>
